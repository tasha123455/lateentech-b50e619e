...
function __countryNameLbl(code){if(code==='LY')return __ar()?'ليبيا':'Libya';return COUNTRY_NAMES[code]||code;}
const CATEGORY_DATA=[
...
window.__bizSelSym=function(){const e=window.__bizEarnByCur||{};const k=window.__bizWalletCur||Object.keys(e)[0]||'USD';return (e[k]&&e[k].sym)||'$';};
...
recomputeAnalytics=function(){
  ...
  try{
    ...
    const codes=Object.keys(byCur);if(!window.__bizWalletCur||!byCur[window.__bizWalletCur])window.__bizWalletCur=codes[0]||'USD';
