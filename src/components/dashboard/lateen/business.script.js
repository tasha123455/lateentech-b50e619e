...
function __money(n,sym,code){const a=parseFloat(n||0).toFixed(2);const cc=(code||__SYM2CODE[__stripDirMarks(sym||'')]||'').toString().toUpperCase();const r=__stripDirMarks(__rawSym(sym||'£',cc));const isAr=(typeof document!=='undefined'&&document.documentElement.lang==='ar');return isAr?('\u2066'+r+a+'\u2069'):(cc?(a+' '+cc):(r+a));}
