...
function buildOrdActions(o){if(o.status==='delivered'||o.status==='failed'){return`<div class="actions"><button class="btn btn-lock" disabled>${o.status==='delivered'?'✓ Delivered':'Failed'}</button></div>`;}let b='';if(o.status==='new')b+=`<button class="btn btn-confirm" onclick="event.stopPropagation();advance('${o.id}','confirmed')">Confirm order</button>`;if(o.status==='confirmed')b+=`<button class="btn btn-deliver" onclick="event.stopPropagation();advance('${o.id}','delivered')">Mark delivered</button>`;if(o.status==='new'||o.status==='confirmed')b+=`<button class="btn btn-fail" onclick="event.stopPropagation();advance('${o.id}','failed')">Failed</button>`;return`<div class="actions">${b}</div>`;}
      ...
      <div class="order-card ${isExp?'expanded':''}" data-status="${o.status}" data-id="${o.id}">
        ...
        <div class="detail-body">
          ...
          <div class="box">
            ...
            ${o.size?`<div class="r"><span class="k">Size</span><span class="v">${o.size}</span></div>`:''}
            ${o.color?`<div class="r"><span class="k">Colour</span><span class="v">${o.color}</span></div>`:''}
          </div>
