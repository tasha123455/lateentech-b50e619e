...
function closeForm(){document.getElementById('form-overlay').classList.remove('open');editingId=null;photos=[];variantGroups=[];variantMode='none';simpleQty='';zones={};selectedCurrency=null;selectedCategory='';currDropdownOpen=false;countryDropdownOpen=false;cityPanelOpenFor=null;closeCategoryPanel();}
