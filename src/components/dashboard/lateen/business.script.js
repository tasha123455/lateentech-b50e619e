      ...
      <div class="order-card ${isExp?'expanded':''}" data-status="${o.status}" data-id="${o.id}">
        ...
        <div class="detail-body">
          ...
          <div class="box">
            ...
            ${variantThumb?`<div class="r"><span class="k">Variant photo</span><span class="v">${variantThumb}</span></div>`:''}
          </div>
