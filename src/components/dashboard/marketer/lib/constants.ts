...
export const LIBYA_CITIES: Array<{ en: string; ar: string }> = [
  ...
  { en: "Ras Lanuf", ar: "راس لانوف" }, { en: "Suluq", ar: "سلوق" }, { en: "Al Abyar", ar: "لبيار" },
  { en: "Tocra", ar: "توكره" }, { en: "Ghemines", ar: "قمينس" }, { en: "Yafran", ar: "يفرن" },
  { en: "Zintan", ar: "الزنتان" }, { en: "Jadu", ar: "جادو" }, { en: "Nalut", ar: "نالوت" },
  { en: "Mizda", ar: "مزدة" }, { en: "Ubari", ar: "اوباري" }, { en: "Murzuq", ar: "مرزق" },
  { en: "Al Kufra", ar: "الكفره" }, { en: "Jalu", ar: "جالو" }, { en: "Awjila", ar: "اوجله" },
  ...
  { en: "Murad Masud", ar: "مراد مسعود" }, { en: "Al Aquriyah", ar: "العقوريه" }, { en: "Zueitina", ar: "زويتنه" },
  { en: "Al Bakkur", ar: "البكور" }, { en: "Al Wardiyah", ar: "الورديه" }, { en: "Farzughah", ar: "فرزوغه" },
  { en: "Tacnis", ar: "تاكنس" }, { en: "Battah", ar: "بطه" }, { en: "Jardas", ar: "جردس" },
  { en: "Zawiyat al Arqub", ar: "زاوية العرقوب" }, { en: "Belhadid", ar: "بلحديد" },
  { en: "Qasr Libya", ar: "قصر ليبيا" }, { en: "Wadi al Kuf", ar: "وادي الكوف" },
  { en: "Al Bayadah", ar: "البياضه" }, { en: "Marawah", ar: "مراوه" }, { en: "Massah", ar: "مسه" },
  { en: "Wardamah", ar: "وردامه" }, { en: "Ras Turab", ar: "راس تراب" }, { en: "Qarnadah", ar: "قرناده" },
  { en: "Omar Al Mukhtar", ar: "عمر المختار" }, { en: "Qandulah", ar: "قندوله" }, { en: "Al Haniyah", ar: "الحنيه" },
  { en: "Al Wasitah", ar: "الوسيطه" }, { en: "Al Faidiyah", ar: "الفايديه" }, { en: "Al Abraq", ar: "الابرق" },
  { en: "Al Mansurah", ar: "المنصوره" }, { en: "Belkhather", ar: "بالخاثر" }, { en: "Qardabah", ar: "قرضبه" },
  { en: "Bab al Zaytun", ar: "باب الزيتون" }, { en: "Al Qa'rah", ar: "القعره" }, { en: "Kamboot", ar: "كمبوت" },
  { en: "Al Watar", ar: "الوتر" }, { en: "Bir al Ashhab", ar: "بئر الاشهب" }, { en: "Bardia", ar: "البردي" },
  { en: "Ain Marah", ar: "عين ماره" }, { en: "Martuba", ar: "مرتوبه" }, { en: "Gulf of Bomba", ar: "خليج البمبه" },
  { en: "Ras al Helal", ar: "راس الهلال" }, { en: "Kersa", ar: "كرسه" }, { en: "Al Mikhili", ar: "المخيلي" },
  { en: "Al Aziyat", ar: "العزيات" }, { en: "Al Tamimi", ar: "التميمي" }, { en: "Ain al Ghazalah", ar: "عين الغزاله" },
  { en: "Al Uqaylah", ar: "العقيله" }, { en: "Bin Jawad", ar: "بن جواد" }, { en: "Harawa", ar: "اهراوه" },
  { en: "Wadi Kaam", ar: "وادي كعام" }, { en: "Qasr Al Khiyar", ar: "قصر الخيار" }, { en: "Al Alous", ar: "العلوص" },
  { en: "Bishr", ar: "بشر" }, { en: "The South", ar: "الجنوب" }, { en: "Al Asaba", ar: "الاصابعه" },
  ...
  { en: "Al Shwayrif", ar: "الشويرف" }, { en: "Derj", ar: "درج" }, { en: "Sinawan", ar: "سيناون" },
