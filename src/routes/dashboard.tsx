...
function DashboardPage() {
  ...
  // Only admins may impersonate; if not admin, clear it.
  useEffect(() => {
  ...
  if (role === "admin" && impersonation) {
    return (
      <div>
        ...
        >
          <span>{t("👁 Viewing as")} {impersonation.name} ({t(impersonation.role === "marketer" ? "Marketer" : "Business")}) — {t("read-only support mode")}</span>
          <button
